<section class="feature-area pb-90px">
    <div class=" feature-container">
        <div class="row rows feature-content-wrap">
            <div class="col-lg-4  responsive-column-half feature-div">
                <div class="info-box">
                    ...
                    <h3 class="info__title">What we Do?</h3>
                    <p class="info__text">Promotion of online stores through targeted advertising, customer ratings, and reviews.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4  responsive-column-half feature-div">
                <div class="info-box">
                    ...
                    <h3 class="info__title">How We Do This?</h3>
                    <p class="info__text">We engage with them through targeted social media ads, Google Ads, and various social media groups, pages, and channels.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half feature-div">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Why We Do This?</h3>
                    <p class="info__text">We do this to increase visibility, build trust, and drive sales for online stores through targeted ads, positive ratings, and reviews.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
