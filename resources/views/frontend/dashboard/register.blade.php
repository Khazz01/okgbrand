    ...
    <div class="container">
        ...
        <form method="POST" class="pt-4" action="{{ route('register') }}">
            ...
            <x-input-label for="password" :value="__('Password')" />
                    ...
                    <x-text-input class="form-control form--control" id="password" type="password" name="password" placeholder="Password"/>
                    <span class="la la-user input-icon"></span>
            ...
            <x-input-label for="password_confirmation" :value="__('Confirm Password')" />
                <div class="form-group">
                    <x-text-input class="form-control form--control" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm password"/>
                    <span class="la la-user input-icon"></span>
                </div>
