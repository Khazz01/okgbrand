...
================================= -->
<section id="Become-A-Staff" class="hero">
    <div class="container">
    <div class=" hero-container">
      <div class="hero-section container-fluid ">
        <div class="hero-content">
          ...
          <p>Welcome to the OKG BRAND "Become a Staff" page! Explore opportunities to join our team, learn about our roles and values, and take the first step toward contributing to our collaborative and innovative environment.</p>
...
<!--======================================
        START FEATURE AREA
 ======================================-->
<section class="become-a-staff-feature feature-area section--padding bg-gray">
    <div class="container">
        <div class="feature-heading-content-wrap text-center">
            <div class="section-heading">
                <h2 class="section__title">Get Paid by<br>
                     Completing Simple Tasks</h2>
        ...
        <div class="row pt-60px">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box before-none">
                    ...
                    <h3 class="info__title"> Submit Entries</h3>
                    <p class="info__text">Engage in store promotions or email marketing by submitting your entries through your dashboard.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box before-none">
                    ...
                    <h3 class="info__title"> Utilize your skills</h3>
                    <p class="info__text">Whether you are a video editor, graphic designer, or web developer, OkgBrand offers opportunities for professionals in all of these fields.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class=" col-lg-4 responsive-column-half">
                <div class=" info-box before-none">
                    ...
                    <h3 class="info__title">03. Join Community</h3>
                    <p class="info__text">Join our <a style="color:#16C47F" href="https://wa.me/2347070659197?text=Hello%20there!" target="_blank">WhatsApp</a> community, where we collaborate on projects and foster connections with fellow team members.</p>
...
<!--======================================
        START REGISTER AREA
======================================-->
<section class="register-area staff-register-area section--padding dot-bg overflow-hidden">
    <div class="container">
        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
        <form method="post" class="row" action="{{route('register.staff')}}">
            @csrf
            ...
            <div class="btn-box col-lg-12">
                <div class="custom-control custom-checkbox mb-4 fs-15">
                    ...
                    <label class="custom-control-label custom--control-label" for="agreeCheckbox">By signing i agree to the
                        <a href="{{route('TNC')}}#BecomeAStaff" class="text-color hover-underline">terms and conditions</a> and
                        <a href="{{route('privacy.policy')}}" class="text-color hover-underline">privacy policy</a>
                    </label>
                </div><!-- end custom-control -->
                <button class="btn btn-outline-primary theme-btn" type="submit">Apply Now <i class="la la-arrow-right icon ml-1"></i></button>
            </div><!-- end btn-box -->
        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
